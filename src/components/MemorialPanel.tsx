  ...
  return (
    <div dir="rtl" className="mt-4 rounded-lg border border-rose-900/40 bg-neutral-900/50 p-4 sm:p-6">
      ...
      <div className="mt-6 flex flex-col gap-4 sm:flex-row sm:items-start">
        <div className="flex-1 space-y-4 text-justify text-sm leading-7 text-neutral-300">
          <p>
          ...
          <p>
            עדן למדה עבודה סוציאלית באוניברסיטת תל אביב ובחרה במקצוע שהיה נטוע עמוק בערכים שלה – חמלה, רצון לקדם
            אוכלוסיות מוחלשות והאמונה באנשים לבנות מחדש את חייהם. גם עדן בעצמה גדלה בבית לא פשוט ועברה גירושים קשים של
            הוריה, באופן שחינך אותה להיות עצמאית ופעלתנית, ולא לקבל את נסיבות חייה כפי שהם. כך היא עבדה עם ילדים
            במועדוניות רווחה, במסגרות עם קשישים, חולים, פוסט-טראומטים והלומי קרב. מקום עבודתה האחרון היה מחלקת הרווחה
            בגבעתיים, שם תמכה באמהות חד הוריות, הומלסים ומשפחות קשות יום.
          </p>
        </div>
      ...
      <p className="mt-4 text-justify text-sm leading-7 text-neutral-300">
      ...
      <div className="mt-4 flex flex-col gap-4 sm:flex-row sm:items-start">
        <div className="flex-1 text-justify text-sm leading-7 text-neutral-300">
          <p>
      ...
      <p className="mt-6 text-center text-sm font-medium text-rose-200">יהי זכרה ברוך, נמשיך ללכת בדרכה.</p>
    </div>
  );
}
